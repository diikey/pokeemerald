...
static const struct WindowTemplate sStandardBattleWindowTemplates[] =
{
    ...
    [B_WIN_PP] = { // Unused now that the "PP" label is gone
        .bg = 0,
        .tilemapLeft = 21,
        .tilemapTop = 55,
        .width = 0,
    ...
    [B_WIN_PP_REMAINING] = { // Bottom row of the info box: "35/35"
        .bg = 0,
        .tilemapLeft = 21,
        .tilemapTop = 57,
        .width = 8,
    ...
    [B_WIN_MOVE_TYPE] = { // Top row of the info box: blank backdrop behind the type/category icon sprites
        .bg = 0,
        .tilemapLeft = 21,
        .tilemapTop = 55,
        .width = 8,
